...
public class WindowAddNewSubject extends Window implements Constants {
	

	private static final long serialVersionUID = 1L;	

	rightContentAddNewSubject rContent  ;
	
	
	
	public WindowAddNewSubject() {

		
		setCaption("Thêm thông tin bộ môn ");//Constants.USER_CAPTION) ;
		...
		rContent = new rightContentAddNewSubject() ;
