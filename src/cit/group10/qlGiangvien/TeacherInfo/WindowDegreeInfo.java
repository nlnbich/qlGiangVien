...
public class WindowDegreeInfo extends Window implements Constants {
	...
	public WindowDegreeInfo() {

		
		setCaption("Thống tin học hàm học vị");//Constants.USER_CAPTION) ;
		...
		//--------------------bl
		Label title = new Label("<center><h1>Thông tin học hàm <h1></center>", Label.CONTENT_XHTML) ;
