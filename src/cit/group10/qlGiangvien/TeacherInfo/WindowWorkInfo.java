...
public class WindowWorkInfo extends Window implements Constants {
	...
	public WindowWorkInfo() {

		
		setCaption("Thông tin công tác ");//Constants.USER_CAPTION) ;
		...
		//--------------------bl
		Label title = new Label("<center><h1>Thông tin công tác <h1></center>", Label.CONTENT_XHTML) ;
