...
public class WindowTimtheohochamhocvi extends Window implements Constants {
	...
	public WindowTimtheohochamhocvi() {

		
		setCaption("Tìm theo học hàm, học vị ");//Constants.USER_CAPTION) ;
		...
		//--------------------bl
		Label title = new Label("<center><h1>Tìm theo học hàm, học vị<h1></center>", Label.CONTENT_XHTML) ;
