...
public class leftSideThongKe extends CustomComponent implements Constants, ItemClickListener {
...
//		setWidth(Constants.WIDTH_LEFT_MENU, Sizeable.UNITS_PIXELS);S
		...
		switch (userRole){
		case 1 :
			for (int i=0; i< MAIN_MENU_TEXT_ADMIN[3].length; i++) leftMenu.addItem(MAIN_MENU_TEXT_ADMIN[4][i]) ;
			break;
